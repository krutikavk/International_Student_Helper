...
public class IssHelperProviderViewRidesPostedByStudentOutputVO {
	...
	public String toString() {
		return "IssHelperProviderViewRidesPostedByStudentOutputVO [RRBS_Id=" + RRBS_Id + ", RRBS_S_Id=" + RRBS_S_Id
				+ ", RRBS_Date=" + RRBS_Date + ", RRBS_Time=" + RRBS_Time + ", RRBS_Air_Code=" + RRBS_Air_Code
				+ ", RRBS_T_Number=" + RRBS_T_Number + ", RRBS_Seats=" + RRBS_Seats + "]";
	}
