...
public class IssHelperRidesPostedByStudentOutputVO {
	...
	public String toString() {
		return "IssHelperRidesPostedByStudentOutputVO [RRBS_Id=" + RRBS_Id + ", RRBS_Date=" + RRBS_Date + ", RRBS_Time="
				+ RRBS_Time + ", RRBS_Air_Code=" + RRBS_Air_Code + ", RRBS_T_Number=" + RRBS_T_Number + ", RRBS_Seats="
				+ RRBS_Seats + ", RRBS_Street=" + RRBS_Street + ", RRBS_City=" + RRBS_City + ", RRBS_State="
				+ RRBS_State + ", RRBS_Zip=" + RRBS_Zip + "]";
	}
