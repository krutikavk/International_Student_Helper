...
public class IssHelperGetAlreadyBookedRidesForStudentInputVO {
	...
	public String toString() {
		return "IssHelperGetAlreadyBookedRidesForStudentInputVO [date=" + date + ", landing_time=" + landing_time
